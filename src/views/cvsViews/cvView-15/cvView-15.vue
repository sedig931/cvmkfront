<template>
  <div
    class="cv-container-div-15 flex-column"
    :class="
      this.lng.name === 'arabic' ? 'arabic-font' : 'cv-container-div-15-font'
    "
  >
    <div class="section-div-15 flex-row">
      <div class="inner-section-div-15 flex-row">
        <div
          class="title-section-div-15 flex-column body-element-txt-15"
          :class="
            this.corner === true
        ...
        <div class="body-section-div-15 top-right-corner flex-column">
          <div
            class="contacts-div-15 flex-row body-element-txt-15"
            style="font-size: 13px"
          >
            <div class="single-contact-div flex-row">
              <i class="bi bi-geo-alt-fill img"></i>
            ...
            <div class="single-contact-div">
              <i class="bi bi-telephone-fill img"></i>
              {{
                this.resumeValues.phone ? this.resumeValues.phone : "0123456789"
              }}
            </div>
            <div class="single-contact-div">
              <i class="bi bi-envelope-at-fill img"></i>
              {{
          ...
          <div
            ...
            "
          >
            <span class="body-element-txt-15" style="font-size: 20px">{{
              this.resumeValues.fullName
                ? this.resumeValues.fullName
                : this.lng.lang.section2.getCvInfo.frame.fullName
            }}</span>
            <span class="body-element-txt-15" style="font-size: 18px">{{
              this.resumeValues.jobTitle
                ? this.resumeValues.jobTitle
                : this.lng.lang.section2.getCvInfo.frame.jobTitle
            }}</span>
          </div>
          <div class="intro-div body-element-txt-15" style="font-size: 14px">
            {{
          ...
          <div class="general-info-div flex-row m-15">
            <div
              class="columns-grid-div body-element-txt-15"
    ...
    <div class="section-div-15 flex-row">
      <div class="inner-section-div-15 flex-row">
        ...
        <div
          class="body-section-div-15 flex-column body-element-txt-15"
          style="font-size: 14px"
        >
          <div>
            <span
          ...
          <div v-if="this.resumeValues.coursesForm[0].courseTitle">
            <span class="txt-bolder">
              {{ this.lng.lang.section2.getCvInfo.frame.courses + " : " }}</span
            >
    ...
    >
      <div class="inner-section-div-15 flex-row">
        ...
        <div class="body-section-div-15 flex-column">
          <div class="workExp-outer-div flex-row">
            <div class="workExep-columns-div">
              <div v-for="(work, i) in this.resumeValues.workExpForm" :key="i">
                <i
                  class="bi bi-briefcase-fill m-1 body-element-txt-15"
                  style="font-size: 15px"
                ></i>
                <span
                  class="txt-bolder body-element-txt-15"
                  style="font-size: 15px"
                  >{{ work.jobTitle }}</span
                >
                <div
                  class="work-body-div ms-2 me-2 body-element-txt-15"
                  style="font-size: 14px"
                >
                  <div>
    ...
    <div
      class="section-div-15 links-section-15 flex-row"
    ...
    <div class="section-div-15 languages-section-15 flex-row">
      <div class="inner-section-div-15 flex-row">
        <div
          class="title-section-div-15 flex-column body-element-txt-15"
          :class="
        ...
        <div
          class="body-section-div-15 bottom-right-corner languages-body-element-section-div flex-column body-element-txt-15"
          style="font-size: 14px"
        >
...
export default {
  ...
  methods: {
    checkContainersSize() {
      const cvContainerHeight = document
        .querySelector(".cv-container-div-15")
        .getBoundingClientRect().height;

      let sectionsHeights = document.querySelectorAll(".section-div-15");
      ...
      while (sectionsHeightsSum > cvContainerHeight) {
        ...
        document.querySelectorAll(".body-element-txt-15").forEach((el) => {
          if (
            Number(
        ...
        sectionsHeights = document.querySelectorAll(".section-div-15");
  ...
  mounted() {
    ...
    // if (this.corner) {
    //   document.querySelector(".top-left-corner").style.borderRadius =
    //     "15px 0 0 0";
    //   document.querySelector(".top-right-corner").style.borderRadius =
    //     "0 15px 0 0";
    //   document.querySelector(".bottom-left-corner").style.borderRadius =
    //     "0 0 0 15px";
    //   document.querySelector(".bottom-right-corner").style.borderRadius =
    //     "0 0 15px 0";
    // }
  },
};
...
.inner-section-div-15 {
  flex: 1;
  height: 100%;
}
.title-section-div-15 {
  flex: 0.3;
  height: 100%;
  /* ----------------------------- */
  /* min-width: 100px; */
